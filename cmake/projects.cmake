...
MACRO(ADD_ENGINE_LIBRARY name)
	...
	TARGET_COMPILE_DEFINITIONS(${name} PRIVATE -DMODULE_NAME="${name}")

	IF(TEST_SOURCES)
		ADD_ISPC_EXECUTABLE(${name}_test ${TEST_SOURCES} ${CONVERTER_SOURCES} ${ISPC_SOURCES})

		TARGET_COMPILE_DEFINITIONS(${name}_test PRIVATE -DMODULE_NAME="${name}_test")
...
MACRO(ADD_ENGINE_PLUGIN name)
	...
	# Setup engine plugin.
	ADD_ISPC_LIBRARY(${name} SHARED ${PRIVATE_SOURCES} ${PUBLIC_SOURCES} ${ISPC_SOURCES} ${TEST_SOURCES})
