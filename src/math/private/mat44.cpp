...
namespace Math
{
	...
	Mat44 Mat44::operator*(f32 Rhs) { return Mat44(Row0_ * Rhs, Row1_ * Rhs, Row2_ * Rhs, Row3_ * Rhs); }
	...
	void Mat44::Inverse()
	{
		...
		Det = (-Det3_201_123 * Lhs[3][0] + Det3_201_023 * Lhs[3][1] - Det3_201_013 * Lhs[3][2] +
		       Det3_201_012 * Lhs[3][3]);
	...
	{
		return Vec2(
		    Lhs.x * Rhs[0][0] + Lhs.y * Rhs[1][0] + Rhs[3][0], Lhs.x * Rhs[0][1] + Lhs.y * Rhs[1][1] + Rhs[3][1]);
	}
